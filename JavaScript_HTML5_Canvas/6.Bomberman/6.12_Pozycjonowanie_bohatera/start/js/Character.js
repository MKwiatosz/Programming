...
Character.prototype.draw = function(){
	...
	Game.ctx.drawImage(
		...
		this.fW,
		this.fH,
		this.states[this.state].flip ? (-this.fW-this.mod_x-this.x)*VAR.scale : (this.x+this.mod_x)*VAR.scale,// jeśli postać jest odbita lustrzanie jego pozycja musi zostać przesunięta o szerokość klatki i pomnożona przez -1
