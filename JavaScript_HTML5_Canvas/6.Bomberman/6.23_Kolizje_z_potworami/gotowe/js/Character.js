...
// Czy bohater wlazł na kurczaka (zwraca prawdę lub fałsz)
Hero.prototype.enemyHitTest = function(){
	// Ponieważ bohater i kurczak przemieszczają się płynnie pomiędzy kolumnami i rzędami to nie możemy porównywać tylko rzędów i kolumn
	// Sprawdzam wszystkich wszystkich wrogów na planszy
	for(var e in Enemy.all){
		// Dla ułatwienia do e przypiszę obiekt a nie tylko jego id
		e = Enemy.all[e];
		// porównuję dokładną pozycję x i y (zakłądając szerokość kurczaka i bohatera na szerokość pola planszy)
...
// Teraz wystarczy rozszerzyć metodę draw
Hero.prototype.draw = function(){
	this.parent.draw.call(this);
	// ustaw KO jeśli bohater został zabity przez kurczaka
